...
namespace DapperExtensions
{
    public static class DapperAsyncExtensions
    {
        ...
        public static async Task<T> SingleOrDefaultAsync<T>(this IDbConnection connection, object predicate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            return await Instance.SingleOrDefaultAsync<T>(connection, predicate, transaction, commandTimeout);
        }

        public static async Task<T> FirstOrDefaultAsync<T>(this IDbConnection connection, object predicate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
